                ...
                $query = 'SELECT category_id, category  FROM categories';
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <tr>
                            <td><a href="nominate.php?id=<?php echo $row['category_id'];?>"><?php echo $row['category'];?></a></td>
                            </tr>
            <?php }
                      ...
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="transac.php?action=add">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="category" name="Cat">
                            </div>
                            <button type="submit" name="submit" class="btn btn-default">Save Record</button>
