                            ...
                            <thead>
                              ...
                              while($row = mysqli_fetch_assoc($result)){ ?>
                               <tr>
                                ...
                                <tbody>
                                <?php
                                        $nominees = "SELECT nominee 
                                        FROM nominations
                                        WHERE nominations.category_id = '".$id."'";
                                  ...
                                  <td>
                                    ...
                                    <div class="form-check">
                                      <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="radio" value="<?php  echo $row['nominee']; ?>"><?php  echo $row['nominee']; ?>
                                      </label>
                                    </div>
                                ...
                                ?>
                                <tr>
                                <button type="aubmit" class="btn btn-primary" name="submit">
                                  VOTE YOUR WINNER
                                </button>
...
$query = 'SELECT category_id  FROM vote';
    $result = mysqli_query($db, $query) or die (mysqli_error($db));
    ?>
